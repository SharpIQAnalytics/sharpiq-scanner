...
conn.commit()
cursor.execute('SELECT home_team,away_team,home_odds,away_odds,best_price_home,best_price_away FROM games WHERE result IS NULL')
columns=['home_team','away_team','home_odds','away_odds','best_price_home','best_price_away']
